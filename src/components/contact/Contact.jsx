...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 bg-primary">
      <div className="container mx-auto grid lg:grid-cols-2 gap-8 p-10 rounded-lg bg-white">
        ...
        <h1 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#AD13FB] to-[#e43a15]">
          ...
          <div className="options space-y-6">
            <a href="mailto:mileslegend7@gmail.com" className="flex items-center text-lg space-x-4 text-secondary hover:text-foreground transition-all">
              <span className="flex-center icon-wrapper bg-accent p-2 rounded-full">
              <MdAttachEmail />
              </span>
              <span>mileslegend7@gmail.com</span>
            </a>
            <a href="tel:+256759060525" className="flex items-center text-lg space-x-4 text-secondary hover:text-foreground transition-all">
              <span className="flex-center icon-wrapper bg-accent p-2 rounded-full">
              <FaPhone />
              </span>
              <span>+256759060525</span>
            </a>
            <a href="#" className="flex items-center text-lg space-x-4 text-secondary hover:text-foreground transition-all">
              <span className="flex-center icon-wrapper bg-accent p-2 rounded-full">
              <ImLocation2 />
              </span>
        ...
        <form ref={form} onSubmit={sendEmail} className="contact-form">
          <div className="top mb-4">
            <p className="text-secondary">Need help on Registering? Kindly reach out for any inquiries; I'm here for you!</p>
          </div>
          <div className="middle space-y-4">
            ...
            <div className="flex flex-wrap gap-4">
              <input type="email" placeholder="Email Address" name='email'className=" border-b-2 border-primary focus:border-primary1 w-full md:w-1/2 py-2 bg-transparent text-foreground" />
              <input type="tel" placeholder="Phone Number" name='tel' className=" border-b-2 border-primary focus:border-primary1 w-full md:w-1/2 py-2 bg-transparent text-foreground" />
            </div>
            <textarea name='message' className=" border-b-2 border-primary focus:border-primary w-full py-2 bg-transparent text-foreground text-primary1" rows="6" placeholder="Type your message here"></textarea>
          </div>
          <div className="bottom mt-8 flex justify-center">
            <button type="submit" className="btn primary bg-primary-dark text-white py-3 px-6 rounded-lg w-full max-w-xs">Send Message</button>
          </div>
          </form>
