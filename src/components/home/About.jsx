...
const About = () => {
  return (
    <section className=" about-home-background lg:py-5">
      <div className=" px-4 text-white flex flex-col gap-5 my-6 lg:px-[2vw]">
        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold">About Our Music Academy</h2>

        <div className="main-content flex flex-col gap-5 sm:grid sm:grid-cols-2 px-[3vw] lg:gap-[3vw]">
          <div className="text-sm tracking-wide leading-6 flex flex-col gap-4 md:text-base lg:text-lg">
          ...
          <div className="relative max-w-[360px] lg:max-w-[420px] h-fit mx-auto">
