  ...
  return (
    <section>
      <div className="text-center p-10 bg-primary">
        <h1 className="font-bold text-4xl mb-4 text-white">Our Programs</h1>
        <p className="text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus adipisci molestiae error earum rerum tempore, tenetur maxime quam laborum voluptatibus blanditiis veritatis at dolore quidem eligendi ex minima, repellendus dignissimos?</p>
